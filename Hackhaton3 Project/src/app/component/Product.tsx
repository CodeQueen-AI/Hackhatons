...
export default function OurProduct() {
  ...
  <div className="flex items-center justify-center mb-8"> {/* Centering the content horizontally */}
    <h1 className="text-4xl font-extrabold text-[#1C1B1F] tracking-tight text-center"> {/* Centering the text */}
      Our Products
    </h1>
  </div>
